    ...
    <div className="solid_product">
      <div className="solid_product_container">
        <div className="solid_left">
          <img
            className="solid_img"
            src={mostSolidData[mostSolidId - 1].image}
            alt=""
          />
        </div>
        ...
        <div className="solid_right">
          <h1 style={{ width: "90%" }}>
            {mostSolidData[mostSolidId - 1].description}
          </h1>
          <div className="share_container">
            <p className="txt">{mostSolidData[mostSolidId - 1].text}</p>
            <div className="share">
              <div>
          ...
          <p style={{ width: "80%" }}>
            {mostSolidData[mostSolidId - 1].readMore}...{" "}
            <span className="read_more">Read More</span>
          </p>
          <p className="deliv">
            {" "}
            <BsCheck style={{ fontSize: "1.3rem" }} />
            {mostSolidData[mostSolidId - 1].delivery}
          </p>
          <p style={{ fontWeight: "bold" }}>
            €{mostSolidData[mostSolidId - 1].newPrice}
          </p>
      ...
      <div className="description_specification">
        <div className="description">
          <h3>Description</h3>
          <p>{mostSolidData[mostSolidId - 1].longDescription}</p>
        ...
        <div className="specification">
                ...
                {mostSolidData[mostSolidId - 1].specification.map((spec,index)=>{
